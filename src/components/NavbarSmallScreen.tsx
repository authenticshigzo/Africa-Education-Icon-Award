                ...
                <div className="bg-[#0F0E0C] w-full px-0 py-2 flex flex-col items-stretch justify-center">
                    <div className="bg-[#0F0E0C] w-full px-0 py-2 flex flex-col items-stretch justify-center">
                        <div className="relative" onMouseEnter={() => openMenu('about')} onMouseLeave={closeMenu}>
                            <Link to="/about" className="text-white hover:bg-[#3B301C] flex items-center justify-center gap-2 hover:text-[#EDAE1D] px-4 py-3 rounded" onClick={blocker}>About<img src={activeMenu === 'about' ? arrowup : arrowdown} alt={activeMenu === 'about' ? "Arrow Up" : "Arrow Down"} className="h-3 w-3 object-contain" /></Link>
                        ...
                        <div className="relative" onMouseEnter={() => openMenu('icon')} onMouseLeave={closeMenu}>
                            <Link to="/icon" className="text-white hover:bg-[#3B301C] flex items-center justify-center gap-2 hover:text-[#EDAE1D] px-4 py-3 rounded" onClick={blocker}>Icon<img src={activeMenu === 'icon' ? arrowup : arrowdown} alt={activeMenu === 'icon' ? "Arrow Up" : "Arrow Down"} className="h-3 w-3 object-contain" /></Link>
                        ...
                        <div className="relative" onMouseEnter={() => openMenu('recognition')} onMouseLeave={closeMenu}>
                            <Link to="/recognition" className="text-white hover:bg-[#3B301C] flex items-center justify-center gap-2 hover:text-[#EDAE1D] px-4 py-3 rounded" onClick={blocker}>Recognition<img src={activeMenu === 'recognition' ? arrowup : arrowdown} alt={activeMenu === 'recognition' ? "Arrow Up" : "Arrow Down"} className="h-3 w-3 object-contain" /></Link>
                        ...
                        <div className="relative" onMouseEnter={() => openMenu('nominees')} onMouseLeave={closeMenu}>
                            <Link to="/nominees" className="text-white hover:bg-[#3B301C] flex items-center justify-center gap-2 hover:text-[#EDAE1D] px-4 py-3 rounded" onClick={blocker}>Nominees<img src={activeMenu === 'nominees' ? arrowup : arrowdown} alt={activeMenu === 'nominees' ? "Arrow Up" : "Arrow Down"} className="h-3 w-3 object-contain" /></Link>
                        ...
                        <div className="relative" onMouseEnter={() => openMenu('participate')} onMouseLeave={closeMenu}>
                            <Link to="/participate" className="text-white hover:bg-[#3B301C] flex items-center justify-center gap-2 hover:text-[#EDAE1D] px-4 py-3 rounded" onClick={blocker}>Participate<img src={activeMenu === 'participate' ? arrowup : arrowdown} alt={activeMenu === 'participate' ? "Arrow Up" : arrowdown} className="h-3 w-3 object-contain" /></Link>
